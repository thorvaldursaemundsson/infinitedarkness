...
const Ashra = () => <StarSystem
    ...
    stars={[{
        ...
        axialTilt: -90,
        dayPeriod: 3600 * 2,
        imageURL: 'images/texture_star_ashra.png',
        bodyType: 'star',
        planetoids: [{
            name: 'Feshra',
            ...
            orbitDistance: { apoapsis: 0.1, periapsis: 0.1, unit: 'AU' },
            imageURL: 'images/texture_planet_feshra.png',
            axialTilt: -9,
            dayPeriod: 3600 * 600,
            bodyType: 'planetoid',
        ...
        },
        {
            ...
            age: 3.6,
            satelites: [
                new PlanetRings({ apoapsis: 600, periapsis: 600, unit: 'km' }, [90, 180, 190], 3.6, 0.01),
            ],
            ...
            orbitDistance: { apoapsis: 0.4, periapsis: 0.4, unit: 'AU' },

            imageURL: 'images/texture_planet_noshra.png',
            axialTilt: 1,
            dayPeriod: 3600 * 18,
            bodyType: 'planetoid',
        },
        {
            ...
            orbitDistance: { apoapsis: 0.8, periapsis: 0.8, unit: 'AU' },
            feature: '142 thousand inhabitants',
            imageURL: 'images/texture_planet_neke.png',
            axialTilt: 15,
            dayPeriod: 3600 * 20,
            bodyType: 'planetoid',
        },
        {
            ...
            orbitDistance: { apoapsis: 1.9, periapsis: 1.9, unit: 'AU' },
            axialTilt: 0,
            dayPeriod: 3600 * 24,
            bodyType: 'belt',
        },
        {
            ...
            satelites: [{
                ...
                orbitDistance: { apoapsis: 684400, periapsis: 684400, unit: 'km' },
                satelites: [],
                imageURL: 'images/texture_planet_edis.jpg',
                axialTilt: 0,
                dayPeriod: 3600 * 8,
                bodyType: 'planetoid',
            }],
            ...
            orbitDistance: { apoapsis: 4, periapsis: 4, unit: 'AU' },
            feature: 'asteroid belt orbiting gas giant binary',
            imageURL: 'images/texture_planet_sylvis.jpg',
            axialTilt: 0,
            dayPeriod: 3600 * 11,
        },
        {
            ...
            orbitDistance: { apoapsis: 9, periapsis: 9, unit: 'AU' },
            satelites: [],
            imageURL: 'images/texture_planet_nane.png',
            axialTilt: -45,
            dayPeriod: 3600 * 48,
            bodyType: 'planetoid',
        },
        {
            ...
            satelites: [],
            imageURL: 'images/texture_planet_sarma.png',
            axialTilt: -30,
            dayPeriod: 3600 * 36,
            bodyType: 'planetoid',
        },
        {
            ...
            orbitDistance: { apoapsis: 51, periapsis: 51, unit: 'AU' },
            satelites: [],
            imageURL: 'images/texture_planet_marzanna.png',
            axialTilt: 0,
            dayPeriod: 3600 * 90,
            bodyType: 'planetoid',
        }
