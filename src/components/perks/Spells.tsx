...
export const DimensionalSwap = new SpellTemplate(
    'Dimensional Swap',
    'Spell: You can cause an object to being to exist or seize to exist by finding a virtual parallel universe which is identical in every way except for the objects existence. The object can not be of any previous consequence since it had to have either existed or not in both worlds. The object and its circumstances must be known to you'
);

export const MortisAlbum = new SpellTemplate(
    'Mortis Album',
    'Mutation: body emits no heat, nails and hair become white and matte, you no longer need to breathe air or consume food, instead you subsist on gamma radiation');
