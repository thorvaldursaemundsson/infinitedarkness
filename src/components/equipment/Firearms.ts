...
const Firearms: FireArm[] = [
    ...
    { fireArmClass: 'machinegun', name: 'Skolt Obliderator', damage: '2d10', range: '120m', ammo: '12x28', capacity: 180, fireAction: ['fully-automatic'], armorpiercing: 2, rps: 12, weight: 8600, value: 17000 },
