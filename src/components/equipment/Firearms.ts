...
const Firearms: FireArm[] = [
    //hand guns
    { fireArmClass: 'handgun', name: 'revolver', damage: '1d10', range: '300m', ammo: '10x19', capacity: 6, fireAction: ['double action revolver'], armorpiercing: 2, weight: 800, value: 3500 },
    { fireArmClass: 'handgun', name: 'Grevvy light', damage: '2d6', range: '350m', ammo: '10x21', capacity: 19, fireAction: ['semi-automatic'], armorpiercing: 3, weight: 950, value: 3200 },
    { fireArmClass: 'handgun', name: 'Grevvy duty', damage: '2d8', range: '350m', ammo: '11x21', capacity: 14, fireAction: ['semi-automatic'], armorpiercing: 2, weight: 1200, value: 4000 },
    { fireArmClass: 'handgun', name: 'Merlion Zapper', damage: '2d6', range: '400m', ammo: '10x21', capacity: 12, fireAction: ['semi-automatic'], armorpiercing: 4, weight: 1100, hitbonus: 2, value: 6000 },

    //submachinegun
    { fireArmClass: 'handgun', name: 'Grevvy sub', damage: '1d10', range: '250m', ammo: '9x21', capacity: 24, fireAction: ['semi-automatic', 'fully-automatic'], armorpiercing: 1, rps: 3, weight: 1300, value: 6500 },
    { fireArmClass: 'handgun', name: 'Skolt cleaner', damage: '1d12', range: '300m', ammo: '10x19', capacity: 36, fireAction: ['semi-automatic', 'fully-automatic'], armorpiercing: 1, rps: 3, weight: 1400, value: 7500 },

    //rifle
    { fireArmClass: 'rifle', name: 'Grevvy marksman', damage: '1d12', range: '800m', ammo: '11x17', capacity: 24, fireAction: ['semi-automatic'], armorpiercing: 2, weight: 1900, value: 5200 },
    { fireArmClass: 'rifle', name: 'Skolt Hunter', damage: '1d12', range: '1000m', ammo: '12x20', capacity: 8, fireAction: ['semi-automatic'], armorpiercing: 1, weight: 2300, value: 8000 },
    { fireArmClass: 'rifle', name: 'Skolt LG', damage: '2d10', range: '1200m', ammo: '12x24', capacity: 6, fireAction: ['semi-automatic'], armorpiercing: 2, weight: 3500, value: 7500 },
    { fireArmClass: 'rifle', name: 'Night AV sniper', damage: '2d12', range: '1800m', ammo: '12x28', capacity: 4, fireAction: ['bolt action'], armorpiercing: 4, hitbonus: -1, weight: 8200, value: 8800 },

    //automatic rifle
    { fireArmClass: 'rifle', name: 'Skolt Advanced', damage: '1d12', range: '700m', ammo: '11x21', capacity: 60, fireAction: ['semi-automatic', 'fully-automatic'], armorpiercing: 1, rps: 4, weight: 3200, value: 9000 },
    { fireArmClass: 'rifle', name: 'Merlion predator', damage: '2d10', range: '1100m', ammo: '12x24', capacity: 45, fireAction: ['semi-automatic', 'fully-automatic'], armorpiercing: 2, rps: 5, weight: 3600, value: 12000 },
    ...
    //machinegun
    { fireArmClass: 'machinegun', name: 'Grevvy Tyrant', damage: '1d8', range: '250m', ammo: '9x17', capacity: 110, fireAction: ['fully-automatic'], armorpiercing: 0, rps: 6, weight: 6500, value: 13000 },
    { fireArmClass: 'machinegun', name: 'Merlion Durium', damage: '1d12', range: '900m', ammo: '9x23', capacity: 120, fireAction: ['fully-automatic'], armorpiercing: 2, rps: 8, weight: 4800, value: 18000, hitbonus: 2 },
    { fireArmClass: 'machinegun', name: 'Skolt Obliderator', damage: '2d10', range: '1600m', ammo: '12x28', capacity: 180, fireAction: ['fully-automatic'], armorpiercing: 2, rps: 12, weight: 8600, value: 17000 },
    ...
    { fireArmClass: 'rocketlauncher', name: 'AT-RL', damage: '12d6', range: '3500m', ammo: '50mm rpg', capacity: 1, fireAction: ['bolt action'], armorpiercing: 0, weight: 4600, value: 8500 },
    ...
    { fireArmClass: 'plasma', name: 'Merlion Plasma Cannon', damage: '4d8', range: '100m', ammo: '10hec', capacity: 120, fireAction: ['semi-automatic'], armorpiercing: 0, hitbonus: 1, weight: 6000, value: 29000, description: 'needs protective gear to use' }
];
