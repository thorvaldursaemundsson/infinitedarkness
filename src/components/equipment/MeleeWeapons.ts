...
export class MeleeWeapon implements IMeleeWeapon {
    ...
    constructor(name: string, weight: number, value: number, damage: string, size: "small" | "medium" | "large", strengthRequirement: number, description: string | undefined, hitbonus: string | undefined, armorpiercing: number | undefined) {
        this.size = size;
        this.name = name;
        this.weight = weight;
        this.value = value;
...
const MeleeWeapons: MeleeWeapon[] = [
    { size: 'small', name: 'Batons/hammers/sticks', damage: '1d4', weight: 500, value: 10, strengthRequirement: 2 },
    { size: 'small', name: 'Knife', damage: '1d6', weight: 100, value: 15, description: 'always causes bleeding on damage', strengthRequirement: 1 },
    ...
    { size: 'large', name: 'Longsword', damage: '1d10', hitbonus: '+2 OQ, -2 CQ', armorpiercing: 1, weight: 800, value: 750, description: 'always causes bleeding on damage, +1 meter reach', strengthRequirement: 3 },
    { size: 'large', name: 'Greatsword', damage: '2d6', hitbonus: '+4 OQ, -4 CQ', armorpiercing: 1, weight: 800, value: 750, description: 'always causes bleeding on damage, +1 meter reach', strengthRequirement: 3 },
    { size: 'large', name: 'Long spear', damage: '1d10', hitbonus: '+4 OQ, -4 CQ', armorpiercing: 1, weight: 900, value: 500, description: 'always causes bleeding on damage, +2 meter reach', strengthRequirement: 3 },
    { size: 'large', name: 'Battleaxe', damage: '1d12', hitbonus: '-2 CQ', armorpiercing: 2, weight: 1500, value: 800, description: 'always causes bleeding on damage, +1 meter reach', strengthRequirement: 4 },
