...
const Combat: React.FC = () => {
    return <Section title='Combat'>
        <h2>Index <a id='combatindex'></a></h2>
        <h5><a href='#combat'>Combat start</a></h5>
        <h5><a href='#turns'>Turns</a></h5>
        <h5><a href='#dodge'>Dodging & passive defense</a></h5>
        <h5><a href='#bleed'>Bleeding</a></h5>
        <h5><a href='#armor'>Armor & damage reduction</a></h5>
        <h5><a href='#melee'>Melee attacking</a></h5>
        <h5><a href='#block'>Blocking</a></h5>
        <h5><a href='#ranged'>Ranged attacks</a></h5>
        <h5><a href='#multi'>Multiple attacks</a></h5>
        <h5><a href='#distance'>Distance</a></h5>
        <h5><a href='#cover'>Cover</a></h5>
        <h5><a href='#crits'>Critical hits</a></h5>

        <h3>Combat start <a id='combat'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Turns <a id='turns'></a><a href='#combatindex'>up</a></h3>
        
        <p>Each turn starts with the characters performing one action in order of highest sequence to lowest</p>

        <h3>Dodging & passive defense <a id='dodge'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Bleeding <a id='bleed'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Armor & damage reduction <a id='armor'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Melee attacking <a id='melee'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Blocking <a id='block'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Ranged attacks & guns <a id='ranged'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Multiple attacks <a id='multi'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Distance <a id='distance'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Cover <a id='cover'></a><a href='#combatindex'>up</a></h3>
        ...
        <h3>Critical hits <a id='crits'></a><a href='#combatindex'>up</a></h3>
