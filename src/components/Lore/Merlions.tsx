...
const Merlions: React.FC = () => {
    return <>
        ...
        <p>Merlions are bipedal aliens, generally between 150-180cm tall, weighing at 40-70kg, covered in brown or green furr with blue stripes across their back, they have big pointy ears and black eyes and a tail that reaches the ground.</p>
