...
const CentauriStarSystem = () => <StarSystem
    stars={[{
        ...
        planetoids: [{
            ...
            hydrosphere: 'none',
            orbitDistance: { apoapsis: 0.02, periapsis: 0.02, unit: 'AU' },
        ...
        },
        {
            ...
            orbitDistance: { apoapsis: 1.09, periapsis: 1.09, unit: 'AU' },
    ...
    },
    {
        ...
        planetoids: [{
            ...
            hydrosphere: 'none',
            orbitDistance: { apoapsis: 0.12, periapsis: 0.12, unit: 'AU' },
            satelites: [],
            axialTilt: -7,
        ...
        },
        {
            ...
            orbitDistance: { apoapsis: .95, periapsis: 0.95, unit: 'AU' },
            satelites: [],
            axialTilt: 19,
            dayPeriod: 3600 * 21,
            bodyType: 'planetoid',
    ...
    },
    {
        ...
        planetoids: [{
            ...
            hydrosphere: 'none',
            orbitDistance: { apoapsis: 0.008, periapsis: 0.008, unit: 'AU' },
            axialTilt: -45,
            ...
            satelites: [{
                ...
                temperatureRange: [-100, 100, 200],
                hydrosphere: 'none',
                orbitDistance: { apoapsis: 4000, periapsis: 4000, unit: 'km' },
                satelites: [],
                axialTilt: 45,
                dayPeriod: 3600 * 24 * 18,
                bodyType: 'planetoid',
        ...
        },
        {
            ...
            hydrosphere: 'salt water',
            orbitDistance: { apoapsis: 0.03, periapsis: 0.03, unit: 'AU' },
